...
public class ViewProductsForm extends JFrame {
    ...
    private void loadProducts() {
        try {
            ...
            if (hasNextPage) {
                resultLabel.setText("Total Records: " + totalRecords + "  |  → More pages available");
            } else {
    ...
    private void editProduct() {
        ...
        int id = (int) model.getValueAt(selectedRow, 1); // ID shifted because of Sr No
        ...
        int quantity = (int) model.getValueAt(selectedRow, 5);
        ...
        try {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                ...
                for (int i = selectedRows.length - 1; i >= 0; i--) {
                    ...
                    int id = (int) model.getValueAt(row, 1); // ID shifted
