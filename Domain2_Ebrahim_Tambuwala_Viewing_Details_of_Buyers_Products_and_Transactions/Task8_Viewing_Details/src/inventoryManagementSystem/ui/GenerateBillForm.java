...
public class GenerateBillForm extends JFrame {
    ...
    private JLabel paymentLabel, dateLabel, transactionIdLabel;
    private JLabel subtotalLabel, finalTotalLabel;
    ...
    private void loadBill() {
        ...
        try {
            int transactionId = Integer.parseInt(transactionField.getText().trim());
            ...
            transactionIdLabel.setText("Transaction ID: " + bill.getTransactionId());
            ...
            subtotalLabel.setText("Subtotal: " + df.format(bill.getSubtotal()));
            finalTotalLabel.setText("Final Total: " + df.format(bill.getSubtotal()));

        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Invalid Transaction ID.");
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Error loading bill.");
        }
    }
    ...
    private void exportPDF() {
        ...
        try {
            ...
            for (BillItem item : bill.getItems()) {
                ...
                pdfTable.addCell(df.format(item.getUnitPrice()));
                pdfTable.addCell(df.format(item.getTotalPrice()));
            }

            document.add(pdfTable);

            document.add(new Paragraph("\nSubtotal: " + df.format(bill.getSubtotal())));
            document.add(new Paragraph("Final Total: " + df.format(bill.getSubtotal())));
